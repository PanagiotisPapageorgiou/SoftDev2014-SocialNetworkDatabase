...
int setListProperty(List* property,int index,Properties* p);
...
/* PART 3 functions */
int banGraphEdge(Graph* ptrG,Edge* e);
int insertInBanSet(Graph* ptrG, Edge* edgeptr);
EdgeSet* findBanEdgeSet(Graph* ptrG, char* relation,int* errorFlag);
