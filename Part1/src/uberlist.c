...
void createList(ListPtr listp, char* type_name, int (*allocateNode) (void**, void*), int (*destroyNode) (void**), int (*compareNode) (void*, void*), int (*assignNode) (void*, void*), void (*printNode) (void*)){ /* Initialise Generic List using the proper functions */
